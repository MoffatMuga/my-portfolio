...
const Experience = () => {
  return (
    <section id='experience' className='lg:pt-5'>
      <div className='container'>
        <div className='text-center'>
          ...
          <p className='lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7'>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam veniam officia odit vel
            adipisci, perspiciatis, non dolorem ipsa quia mollitia saepe nam? Blanditiis sequi nisi
            similique rerum eum placeat quasi.
          </p>
        </div>
        ...
        <div className='flex flex-col sm:flex-row justify-center items-center mt-6'>
          <div className='w-full sm:w-1/2 mb-4 sm:mb-0'>
            ...
            >
              <h3 className='text-primaryColor text-2xl font-[700] group-hover:text-white group-hover:font-[600] text-center mb-2 sm:mb-4'>
          ...
          <div className='w-full sm:w-1/2'>
            <div
              ...
              className='bg-white p-4 rounded shadow ease-in duration-150'
            >
              <h3 className='text-primaryColor text-2xl font-[700] text-center mb-2 sm:mb-4'>
        ...
        <div>
          <h3 className='text-[1.8rem] text-headingColor text-center font-[600] mb-5 mt-5'>
            My Technologies
          </h3>
        </div>

        <div className='flex flex-wrap justify-center gap-4 cursor-pointer hover:scale-110 transform transition-transform'>
