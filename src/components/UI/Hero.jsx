        ...
        <div className='container pt-14'>
            <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
                ...
                <div className='basis-1/3 mt-10 sm:mt-0 '>
                    ...
                    <div className='w-80 h-80  border-t-8 border-r-4 border-b-4 border-primaryColor absolute rounded-full'></div>
                        <img src="muga.png" alt="moffat" className='rounded-full w-80 glow-object'/>
                    </figure>
                </div>
